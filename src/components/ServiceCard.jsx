...
export default function ServiceCard({ icon: Icon, title, description, href = '/servicios' }) {
  return (
    <div className="group bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-lg hover:border-brand-200 transition-all h-full">
